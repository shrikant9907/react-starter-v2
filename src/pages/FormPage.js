          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code>fui + fui1 / fui1r / fui1p</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code>fui + fui2 / fui2r / fui2p</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2 py_40 px_30">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code>fui fui3 / fui3r / fui3p</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2 py_40 px_30">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code>fui fui4</code><span class="copycode">Copy Code</span>
              </div>
              <div class="card cui2 py_40 px_30">
                <div class="copythis">
                  <div class="card-body">
