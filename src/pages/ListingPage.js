          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code class="mb_10">listing</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="listing">
            ...
            <div class="col-12 col-sm-6">
              <div class="card cui1 w-100">
                <div class="cbody">
                  <div class="codebefore relative">
                    <code class="mb_10">listing type2</code><span class="copycode">Copy Code</span>
                  </div>
                  <div class="copythis">
            ...
            <div class="col-12 col-sm-6">
              <div class="card cui1 w-100">
                <div class="cbody">
                  <div class="codebefore relative">
                    <code class="mb_10">ul listing type3</code><span class="copycode">Copy Code</span>
                  </div>
                  <div class="copythis">
            ...
            <div class="col-12 col-sm-6">
              <div class="card cui1 w-100">
                <div class="cbody">
                  <div class="codebefore relative">
                    <code class="mb_10">ul listing licons</code><span class="copycode">Copy Code</span>
                  </div>
                  <div class="copythis">
            ...
            <div class="col-12">
              <div class="card cui13 w-100">
                <div class="card-body">
                  <div class="codebefore relative">
                    <code class="mb_10">ul listing type4 licons</code><span class="copycode">Copy Code</span>
                  </div>
                  <div class="copythis">
