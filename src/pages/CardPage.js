      ...
      <section class="py_30">
        <div class="container">
          ...
          <div class="row mb_20">
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code class="mb_10">btnui1</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
          ...
          <div class="row mb_20">
            <div class="col-12 col-sm-6">
              <div class="codebefore relative">
                <code class="mb_10">card cdraganddrop</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
          ...
          <div class="row mb_20">
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">ctestimonial + cimagewr + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui1 + ctestimonial + cimagewr + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2c + ctestimonial + cimagewr + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2c + ctestimonial + cimagewrb + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2c ctestimonial">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2c + ctestimonial + cimagewrbc + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2c ctestimonial">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2c + ctestimonial + cimagewrbc + ciconbg</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2c ctestimonial">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2c + ctestimonial + cimagewrbc + ciconbgl</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-3">
              <div class="codebefore relative">
                <code class="mb_10">cui1</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui1">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui1c</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui2c</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui2c">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui3</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="card cui3">
                  <div class="card-body">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui3c</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui4 + litem</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="d-flex">
                  <div class="card cui4">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui4 + ritem</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="d-flex">
                  <div class="card cui4">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">cui4 + stext + litem</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
                <div class="d-flex">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">card cui3c noshadow + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">card cui3c bc_green + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
            ...
            <div class="col-12 col-sm-4">
              <div class="codebefore relative">
                <code class="mb_10">card cui3c bg_yellow + cicon</code><span class="copycode">Copy Code</span>
              </div>
              <div class="copythis">
